...
def get_playlist_id():
    ...
    try: 
        ...
        # quota_user = response.headers.get('X-RateLimit-User-Limit')
        # quota_remaining = response.headers.get('X-RateLimit-User-Remaining')
        # print(f"Quota remaining: {quota_remaining}/{quota_user}")
